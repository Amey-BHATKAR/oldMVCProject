...
include($_SERVER['DOCUMENT_ROOT'].'/forecast/newMVCProj/controllers/displayCustomerForecasts.php');
?>
<html>
...
<div id = "title_block5">
	...
	<table>
	<tr>
		<form action="/forecast/newMVCProj/views/salesViews/displayCustomerForecast.php" method="post">
			<input type="hidden" name="form1" value="form1" />
			<td>Enter the search string here:</td>
			<td><input id = "searchString" type="text" class="text" name="searchString" id="searchString" value="" size="auto" maxlength="auto" title = "Enter any search string related to customer of product name."/></td>
		...
		<table id = "mainTable" border = 1>
			<tr>
				...
				<?php
					...
					{
						getSearchedCustomerForecast($_POST['searchString']);
					}
					else
					{
						getCustomerForecast();
