...
<br>
  	...
  	<div id = "title_block4">
<form method = "post" action = "/forecast/newMVCProj/controllers/calculatedForecast.php">
  	
  		<input type="hidden" name="form1" value="form1" />
 <input type="submit" name="Submit" title = "Confirmation needed since it takes long time to generate the complete calculated forecasts." value="Confirmation to Generate Calculated Forecasts" />
 </form>
