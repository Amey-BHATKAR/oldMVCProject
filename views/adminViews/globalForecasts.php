...
<br>
  	...
  	<div id = "title_block4">
 <form method = "post" action = "/forecast/newMVCProj/controllers/globalForecast.php">
  	
 <input type="hidden" name="form1" value="form1" />
 	<input type="submit" name="Submit" title = "Confirmation needed since it takes long time to generate the complete global forecasts." value="Confirmation to Generate Global Forecasts" />
 </form>
