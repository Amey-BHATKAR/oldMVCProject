<?php   
 ...
 include($_SERVER['DOCUMENT_ROOT']."/forecast/newMVCProj/controllers/class/pDraw.class.php");
 include($_SERVER['DOCUMENT_ROOT']."/forecast/newMVCProj/controllers/class/pImage.class.php");
 ...
 /* Write the title */ 
 $myPicture->setFontProperties(array("FontName"=>$_SERVER['DOCUMENT_ROOT']."/forecast/newMVCProj/controllers/fonts/advent_light.ttf","FontSize"=>40));
 $myPicture->drawText(130,130,"Delayed loading script",array("R"=>255,"G"=>255,"B"=>255));

 /* Write the seed # */ 
 $myPicture->setFontProperties(array("FontName"=>$_SERVER['DOCUMENT_ROOT']."/forecast/newMVCProj/controllers/fonts/advent_light.ttf","FontSize"=>10));
