 ...
 */
 ...
 include("../newMVCProj/controllers/class/pData.class.php");
 include("../newMVCProj/controllers/class/pDraw.class.php");
 include("../newMVCProj/controllers/class/pImage.class.php");

 $myData = new pData();
 if ( $Mode == "Source" )
  {
   echo "&lt;?php\r\n";
   echo 'include("/newMVCProj/controllers/class/pData.class.php");'."\r\n";
   echo 'include("/newMVCProj/controllers/class/pDraw.class.php");'."\r\n";
   echo 'include("/newMVCProj/controllers/class/pImage.class.php");'."\r\n";
   echo "\r\n";
